...
def loadData():
    # 读入数据
    data = sio.loadmat('/tmp/pycharm_project_962/data/Indian_pines_corrected.mat')['indian_pines_corrected']
    # print(data)
    labels = sio.loadmat('/tmp/pycharm_project_962/data/Indian_pines_gt.mat')['indian_pines_gt']
    return data, labels
...
if __name__ == '__main__':
    ...
    net ,device= train(train_loader, epochs=300)
    # 只保存模型参数
    torch.save(net.state_dict(), '/tmp/pycharm_project_962/cls_SSBF_IP/cls_params/SSBFnet_params.pth')
    ...
    Test_time = toc2 - tic2
    file_name = '/tmp/pycharm_project_962/cls_result/classification_report.txt'
